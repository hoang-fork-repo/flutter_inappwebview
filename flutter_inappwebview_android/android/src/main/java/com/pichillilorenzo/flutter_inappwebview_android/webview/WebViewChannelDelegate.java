...
public class WebViewChannelDelegate extends ChannelDelegateImpl {
    ...
    private WeakReference<ValueCallback<Uri[]>> filePathCallback;
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull final MethodChannel.Result result) {
        ...
        switch (method) {
            ...
            case loadUrl:
                if (webView != null) {
                    Map<String, Object> urlRequest = call.argument("urlRequest");
            ...
            case postUrl:
                if (webView != null) {
                    ...
                    byte[] postData = call.argument("postData");
            ...
            case loadData:
                if (webView != null) {
                    ...
                    String historyUrl = call.argument("historyUrl");
            ...
            case loadFile:
                if (webView != null) {
                    String assetFilePath = call.argument("assetFilePath");
                    try {
            ...
            case evaluateJavascript:
                if (webView != null) {
                    ...
                    Map<String, Object> contentWorldMap = call.argument("contentWorld");
            ...
            case injectJavascriptFileFromUrl:
                if (webView != null) {
                    String urlFile = call.argument("urlFile");
                    Map<String, Object> scriptHtmlTagAttributes = call.argument(
            ...
            case injectCSSFileFromUrl:
                if (webView != null) {
                    String urlFile = call.argument("urlFile");
                    Map<String, Object> cssLinkHtmlTagAttributes = call.argument(
            ...
            case goBackOrForward:
                if (webView != null) webView.goBackOrForward(call.argument("steps"));
                result.success(true);
                break;
            case canGoBackOrForward:
                result.success((webView != null) && webView.canGoBackOrForward(call.argument(
                        "steps")));
                break;
            case stopLoading:
            ...
            case takeScreenshot:
                if (webView != null) {
                    Map<String, Object> screenshotConfiguration = call.argument(
            ...
            case setSettings:
                if (webView != null && webView.getInAppBrowserDelegate() instanceof InAppBrowserActivity) {
                    InAppBrowserActivity inAppBrowserActivity =
                            (InAppBrowserActivity) webView.getInAppBrowserDelegate();
                    InAppBrowserSettings inAppBrowserSettings = new InAppBrowserSettings();
                    HashMap<String, Object> inAppBrowserSettingsMap = call.argument("settings");
                    ...
                    HashMap<String, Object> inAppWebViewSettingsMap = call.argument("settings");
            ...
            case startSafeBrowsing:
                if (webView != null && WebViewFeature.isFeatureSupported(WebViewFeature.START_SAFE_BROWSING)) {
                    WebViewCompat.startSafeBrowsing(webView.getContext(),
            ...
            case clearSslPreferences:
                if (webView != null) webView.clearSslPreferences();
                result.success(true);
                break;
            case findAll:
                if (webView != null) {
            ...
            case findNext:
                if (webView != null) {
                    Boolean forward = call.argument("forward");
            ...
            case printCurrentPage:
                if (webView != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    Map<String, Object> settingsMap = call.argument("settings");
                    if (settingsMap != null) {
            ...
            case zoomBy:
                if (webView != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    double zoomFactor = call.argument("zoomFactor");
            ...
            case saveWebArchive:
                if (webView != null) {
                    ...
                    boolean autoname = call.argument("autoname");
            ...
            case requestFocus:
                if (webView != null) {
                    ...
                    Integer direction = call.argument("direction");
                    InAppWebViewRect previouslyFocusedRect =
                            InAppWebViewRect.fromMap(call.argument("previouslyFocusedRect"));
                    if (direction != null && previouslyFocusedRect != null) {
                        resultValue = webView.requestFocus(direction,
                                previouslyFocusedRect.toRect());
            ...
            case setContextMenu:
                if (webView != null) {
                    Map<String, Object> contextMenu = call.argument("contextMenu");
            ...
            case addUserScript:
                if (webView != null && webView.getUserContentController() != null) {
                    Map<String, Object> userScriptMap = call.argument("userScript");
            ...
            case callAsyncJavaScript:
                if (webView != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    Map<String, Object> functionArguments = call.argument("arguments");
                    Map<String, Object> contentWorldMap = call.argument("contentWorld");
                    ContentWorld contentWorld = ContentWorld.fromMap(contentWorldMap);
                    webView.callAsyncJavaScript(functionBody, functionArguments, contentWorld,
            ...
            case postWebMessage:
                if (webView != null && WebViewFeature.isFeatureSupported(WebViewFeature.POST_WEB_MESSAGE)) {
                    WebMessageCompatExt message = WebMessageCompatExt.fromMap(call.argument(
                            "message"));
                    ...
                    if (portsExt != null) {
                        for (WebMessagePortCompatExt portExt : portsExt) {
                            WebMessageChannel webMessageChannel =
                                    webView.getWebMessageChannels().get(portExt.getWebMessageChannelId());
                    ...
                    if (webView instanceof InAppWebView) {
                        try {
                            if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_ARRAY_BUFFER) && data != null && message.getType() == WebMessageCompat.TYPE_ARRAY_BUFFER) {
                                WebViewCompat.postWebMessage(webView,
                                        new WebMessageCompat((byte[]) data,
                                                compatPorts.toArray(new WebMessagePortCompat[0]))
                                        , Uri.parse(targetOrigin));
                            } else {
                                WebViewCompat.postWebMessage(webView,
                                        new WebMessageCompat(data != null ? data.toString() :
                                                null,
                                                compatPorts.toArray(new WebMessagePortCompat[0]))
                                        , Uri.parse(targetOrigin));
                            }
            ...
            case addWebMessageListener:
                if (webView != null) {
                    Map<String, Object> webMessageListenerMap = call.argument("webMessageListener");
                    WebMessageListener webMessageListener = WebMessageListener.fromMap(webView,
                            webView.getPlugin().messenger, webMessageListenerMap);
            ...
            case onFilePicked:
                ...
                String[] files = new Gson().fromJson((String) call.argument("files"),
                        String[].class);
                ValueCallback<Uri[]> callback = filePathCallback.get();
                if (callback != null) {
                    Uri[] uris = new Uri[files.length];
                    for (int i = 0; i < files.length; i++) {
                        uris[i] = Uri.parse(files[i]);
                    }
                    callback.onReceiveValue(uris);
                    filePathCallback.clear();
                }
                break;
    ...
    public void onFilePicker(String[] acceptedType, ValueCallback<Uri[]> filePathCallback) {
        this.filePathCallback = new WeakReference<>(filePathCallback);
        MethodChannel channel = getChannel();
        if (channel == null) return;
        Map<String, Object> obj = new HashMap<>();
        obj.put("acceptedType", new Gson().toJson(acceptedType));
        channel.invokeMethod("onFilePicker", obj);
    }
    ...
    public void onJsAlert(String url, String message, Boolean isMainFrame,
                          @NonNull JsAlertCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
    ...
    public void onJsConfirm(String url, String message, Boolean isMainFrame,
                            @NonNull JsConfirmCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onJsPrompt(String url, String message, String defaultValue, Boolean isMainFrame,
                           @NonNull JsPromptCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onJsBeforeUnload(String url, String message,
                                 @NonNull JsBeforeUnloadCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onCreateWindow(CreateWindowAction createWindowAction,
                               @NonNull CreateWindowCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onGeolocationPermissionsShowPrompt(String origin,
                                                   @NonNull GeolocationPermissionsShowPromptCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onPermissionRequest(String origin, List<String> resources, Object frame,
                                    @NonNull PermissionRequestCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void shouldOverrideUrlLoading(NavigationAction navigationAction,
                                         @NonNull ShouldOverrideUrlLoadingCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onReceivedHttpError(WebResourceRequestExt request,
                                    WebResourceResponseExt errorResponse) {
        MethodChannel channel = getChannel();
        if (channel == null) return;
        Map<String, Object> obj = new HashMap<>();
        obj.put("request", request.toMap());
    ...
    public void onReceivedHttpAuthRequest(HttpAuthenticationChallenge challenge,
                                          @NonNull ReceivedHttpAuthRequestCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onReceivedServerTrustAuthRequest(ServerTrustChallenge challenge,
                                                 @NonNull ReceivedServerTrustAuthRequestCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onReceivedClientCertRequest(ClientCertChallenge challenge,
                                            @NonNull ReceivedClientCertRequestCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onSafeBrowsingHit(String url, int threatType,
                                  @NonNull SafeBrowsingHitCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onLoadResourceWithCustomScheme(WebResourceRequestExt request,
                                               @NonNull LoadResourceWithCustomSchemeCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public CustomSchemeResponse onLoadResourceWithCustomScheme(WebResourceRequestExt request) throws InterruptedException {
        ...
        obj.put("request", request.toMap());
        final SyncLoadResourceWithCustomSchemeCallback callback =
                new SyncLoadResourceWithCustomSchemeCallback();
        return Util.invokeMethodAndWaitResult(channel, "onLoadResourceWithCustomScheme", obj,
                callback);
    }

    public void shouldInterceptRequest(WebResourceRequestExt request,
                                       @NonNull ShouldInterceptRequestCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public WebResourceResponseExt shouldInterceptRequest(WebResourceRequestExt request) throws InterruptedException {
        MethodChannel channel = getChannel();
        if (channel == null) return null;
        final SyncShouldInterceptRequestCallback callback =
                new SyncShouldInterceptRequestCallback();
        return Util.invokeMethodAndWaitResult(channel, "shouldInterceptRequest", request.toMap(),
                callback);
    }

    public void onRenderProcessUnresponsive(String url,
                                            @NonNull RenderProcessUnresponsiveCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onRenderProcessResponsive(String url,
                                          @NonNull RenderProcessResponsiveCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onCallJsHandler(String handlerName, JavaScriptHandlerFunctionData data,
                                @NonNull CallJsHandlerCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public void onPrintRequest(String url, String printJobId,
                               @NonNull PrintRequestCallback callback) {
        MethodChannel channel = getChannel();
        if (channel == null) {
            callback.defaultBehaviour(null);
            return;
    ...
    public static class ShouldOverrideUrlLoadingCallback extends BaseCallbackResultImpl<NavigationActionPolicy> {
        ...
        public NavigationActionPolicy decodeResult(@Nullable Object obj) {
            Integer action = obj instanceof Integer ? (Integer) obj :
                    NavigationActionPolicy.CANCEL.rawValue();
