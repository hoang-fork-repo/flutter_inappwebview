...
class AndroidInAppWebViewController extends PlatformInAppWebViewController
  ...
  static final Map<InAppWebViewKeepAlive,
      InAppWebViewControllerKeepAliveProps?>_keepAliveMap = {};
  ...
  AndroidInAppWebViewController.fromInAppBrowser(
      PlatformInAppWebViewControllerCreationParams params,
      MethodChannel channel, AndroidInAppBrowser inAppBrowser,
  ...
  void _init(PlatformInAppWebViewControllerCreationParams params) {
    ...
    if (params.webviewParams is PlatformInAppWebViewWidgetCreationParams) {
      final keepAlive = (params
          .webviewParams as PlatformInAppWebViewWidgetCreationParams).keepAlive;
      if (keepAlive != null) {
  ...
  _debugLog(String method, dynamic args) {
    debugLog(className: this.runtimeType.toString(),
        name: _inAppBrowser == null ? "WebView" : _inAppBrowser.runtimeType
            .toString(),
        id: (getViewId() ?? _inAppBrowser?.id).toString(),
        debugLoggingSettings: PlatformInAppWebViewController
  ...
  Future<dynamic> _handleMethod(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case "onReceivedError":
        if ((webviewParams != null && (webviewParams!.onReceivedError !=
          ...
          if (webviewParams != null) {
            ...
            if (isForMainFrame) {
              _inAppBrowserEventHandler!.onLoadError(
                  request.url, error.type.toNativeValue() ?? -1,
                  error.description);
            }
      ...
      case "onReceivedHttpError":
        if ((webviewParams != null && (webviewParams!.onReceivedHttpError !=
            null || // ignore: deprecated_member_use_from_same_package
          ...
          if (webviewParams != null) {
            ...
            if (isForMainFrame) {
              _inAppBrowserEventHandler!.onLoadHttpError(
                  request.url, errorResponse.statusCode ?? -1,
                  errorResponse.reasonPhrase ?? '');
            }
      ...
      case "shouldOverrideUrlLoading":
        if ((webviewParams != null &&
            ...
            _inAppBrowserEventHandler != null) {
          Map<String, dynamic> arguments = call.arguments.cast<String,
              dynamic>();
          ...
          if (webviewParams != null &&
            ...
            return (await webviewParams!.shouldOverrideUrlLoading!(
                _controllerFromPlatform, navigationAction))?.toNativeValue();
          return (await _inAppBrowserEventHandler!.shouldOverrideUrlLoading(
              navigationAction))?.toNativeValue();
        }
        break;
      case "onFilePicker":
        if ((webviewParams != null &&
            webviewParams!.onFilePickerOpen != null) ||
            _inAppBrowserEventHandler != null) {
          Map<String, dynamic> arguments = call.arguments.cast<String,
              dynamic>();
          final acceptedType = (jsonDecode(arguments["acceptedType"]) as List<dynamic>).cast<String>();
          if (webviewParams != null && webviewParams!.onFilePickerOpen != null) {
            final files = webviewParams!.onFilePickerOpen!(acceptedType);
            onFilePicked(files);
          }
          // else
          //   _inAppBrowserEventHandler!.onConsoleMessage(acceptedType);
        }
        break;
      ...
      case "onDownloadStartRequest":
        if ((webviewParams !=
          ...
          Map<String, dynamic> arguments = call.arguments.cast<String,
              dynamic>();
          DownloadStartRequest downloadStartRequest = DownloadStartRequest
              .fromMap(arguments)!;
      ...
      case "onLoadResourceWithCustomScheme":
        if ((webviewParams != null &&
            (webviewParams!.onLoadResourceWithCustomScheme !=
                null || // ignore: deprecated_member_use_from_same_package
                webviewParams!.onLoadResourceCustomScheme != null)) ||
            _inAppBrowserEventHandler != null) {
          Map<String, dynamic> requestMap = call.arguments["request"].cast<
              String,
              dynamic>();
          ...
          if (webviewParams != null) {
            if (webviewParams!.onLoadResourceWithCustomScheme != null)
              return (await webviewParams!.onLoadResourceWithCustomScheme!(
                  _controllerFromPlatform, request))?.toMap(); else {
              return (await params.webviewParams!
              // ignore: deprecated_member_use_from_same_package
                  .onLoadResourceCustomScheme!(
                  _controllerFromPlatform, request.url))?.toMap();
            }
          } else {
            return ((await _inAppBrowserEventHandler!
                .onLoadResourceWithCustomScheme(request)) ??
                (await _inAppBrowserEventHandler!.onLoadResourceCustomScheme(
                    request.url)))?.toMap();
          }
        }
        break;
        ...
        if ((webviewParams != null && webviewParams!.onCreateWindow != null) ||
          ...
          if (webviewParams != null && webviewParams!.onCreateWindow != null)
            return await webviewParams!.onCreateWindow!(
                _controllerFromPlatform, createWindowAction); else
      ...
      case "onCloseWindow":
        ...
        else if (_inAppBrowserEventHandler != null) _inAppBrowserEventHandler!
            .onCloseWindow();
        break;
      case "onTitleChanged":
        ...
        if ((webviewParams != null &&
            (webviewParams!.onGeolocationPermissionsShowPrompt !=
                ...
                webviewParams!.androidOnGeolocationPermissionsShowPrompt !=
                    null)) || _inAppBrowserEventHandler != null) {
          ...
          if (webviewParams != null) {
            if (webviewParams!.onGeolocationPermissionsShowPrompt != null)
              return (await webviewParams!.onGeolocationPermissionsShowPrompt!(
                  _controllerFromPlatform, origin))?.toMap(); else {
              return (await params.webviewParams!
              // ignore: deprecated_member_use_from_same_package
                  .androidOnGeolocationPermissionsShowPrompt!(
                  _controllerFromPlatform, origin))?.toMap();
            }
          } else {
            return ((await _inAppBrowserEventHandler!
      ...
      case "shouldInterceptRequest":
        if ((webviewParams != null && (webviewParams!.shouldInterceptRequest !=
            null || // ignore: deprecated_member_use_from_same_package
          ...
          if (webviewParams != null) {
            if (webviewParams!.shouldInterceptRequest != null)
              ...
              return (await webviewParams!.androidShouldInterceptRequest!(
                  _controllerFromPlatform, request))?.toMap();
            }
          } else {
            return ((await _inAppBrowserEventHandler!.shouldInterceptRequest(
                request)) ??
                (await _inAppBrowserEventHandler!.androidShouldInterceptRequest(
                    request)))?.toMap();
          }
        }
        break;
          ...
          if (webviewParams != null) {
            if (webviewParams!.onRenderProcessUnresponsive != null)
              return (await webviewParams!.onRenderProcessUnresponsive!(
                  _controllerFromPlatform, uri))?.toNativeValue(); else {
              // ignore: deprecated_member_use_from_same_package
              return (await webviewParams!.androidOnRenderProcessUnresponsive!(
                  _controllerFromPlatform, uri))?.toNativeValue();
            }
          } else {
            return ((await _inAppBrowserEventHandler!
                .onRenderProcessUnresponsive(uri)) ??
                (await _inAppBrowserEventHandler!
                    .androidOnRenderProcessUnresponsive(uri)))?.toNativeValue();
          }
        }
        break;
        ...
        if ((webviewParams != null &&
          ...
          if (webviewParams != null) {
            ...
            return ((await _inAppBrowserEventHandler!.onRenderProcessResponsive(
                uri)) ?? (await _inAppBrowserEventHandler!
                .androidOnRenderProcessResponsive(uri)))?.toNativeValue();
          }
        }
        break;
      case "onRenderProcessGone":
        if ((webviewParams != null && (webviewParams!.onRenderProcessGone !=
            null || // ignore: deprecated_member_use_from_same_package
      ...
      case "onFormResubmission":
        if ((webviewParams != null && (webviewParams!.onFormResubmission !=
            null || // ignore: deprecated_member_use_from_same_package
          ...
          if (webviewParams != null) {
            ...
            return ((await _inAppBrowserEventHandler!.onFormResubmission(
                uri)) ?? // ignore: deprecated_member_use_from_same_package
      ...
      case "onZoomScaleChanged":
        ...
        break;
      case "onReceivedIcon":
        if ((webviewParams != null && (webviewParams!.onReceivedIcon !=
            null || // ignore: deprecated_member_use_from_same_package
      ...
      case "onReceivedTouchIconUrl":
        if ((webviewParams != null && (webviewParams!.onReceivedTouchIconUrl !=
            null || // ignore: deprecated_member_use_from_same_package
        ...
        if ((webviewParams != null && webviewParams!.onJsAlert != null) ||
          ...
          if (webviewParams != null && webviewParams!.onJsAlert != null)
            return (await webviewParams!.onJsAlert!(
                _controllerFromPlatform, jsAlertRequest))?.toMap(); else
        ...
        if ((webviewParams != null && webviewParams!.onJsConfirm != null) ||
          ...
          if (webviewParams != null && webviewParams!.onJsConfirm != null)
            return (await webviewParams!.onJsConfirm!(
                _controllerFromPlatform, jsConfirmRequest))?.toMap(); else
            return (await _inAppBrowserEventHandler!.onJsConfirm(
                jsConfirmRequest))?.toMap();
        }
        break;
      case "onJsPrompt":
        if ((webviewParams != null && webviewParams!.onJsPrompt != null) ||
          ...
          if (webviewParams != null && webviewParams!.onJsPrompt != null)
            return (await webviewParams!.onJsPrompt!(
                _controllerFromPlatform, jsPromptRequest))?.toMap(); else
            return (await _inAppBrowserEventHandler!.onJsPrompt(
                jsPromptRequest))?.toMap();
        }
        break;
      case "onJsBeforeUnload":
        if ((webviewParams != null && (webviewParams!.onJsBeforeUnload !=
            null || // ignore: deprecated_member_use_from_same_package
          ...
          if (webviewParams != null) {
            if (webviewParams!.onJsBeforeUnload != null)
              ...
              return (await webviewParams!.androidOnJsBeforeUnload!(
                  _controllerFromPlatform, jsBeforeUnloadRequest))?.toMap();
            }
          } else {
            return ((await _inAppBrowserEventHandler!.onJsBeforeUnload(
                ...
                (await _inAppBrowserEventHandler!.androidOnJsBeforeUnload(
                    jsBeforeUnloadRequest)))?.toMap();
          }
        }
        break;
      case "onSafeBrowsingHit":
        if ((webviewParams != null && (webviewParams!.onSafeBrowsingHit !=
            null || // ignore: deprecated_member_use_from_same_package
      ...
      case "onReceivedHttpAuthRequest":
        if ((webviewParams != null &&
          ...
          Map<String, dynamic> arguments = call.arguments.cast<String,
              dynamic>();
          HttpAuthenticationChallenge challenge = HttpAuthenticationChallenge
              .fromMap(arguments)!;

          if (webviewParams != null &&
              webviewParams!.onReceivedHttpAuthRequest != null)
            return (await webviewParams!.onReceivedHttpAuthRequest!(
                _controllerFromPlatform, challenge))?.toMap(); else
          ...
          if (webviewParams != null) {
            if (webviewParams!.findInteractionController != null &&
              ...
              webviewParams!.findInteractionController!.params
                  ...
                  webviewParams!.findInteractionController!, activeMatchOrdinal,
                  numberOfMatches, isDoneCounting);
            else
              webviewParams!.onFindResultReceived!(
                  _controllerFromPlatform, activeMatchOrdinal, numberOfMatches,
                  isDoneCounting);
          } else {
      ...
      case "onPermissionRequest":
        if ((webviewParams != null && (webviewParams!.onPermissionRequest !=
            null || // ignore: deprecated_member_use_from_same_package
      ...
      case "onDidReceiveServerRedirectForProvisionalNavigation":
        if (webviewParams != null && (webviewParams!
      ...
      case "onNavigationResponse":
        if ((webviewParams != null && (webviewParams!.onNavigationResponse !=
            null || // ignore: deprecated_member_use_from_same_package
          ...
          Map<String, dynamic> arguments = call.arguments.cast<String,
              dynamic>();
          // ignore: deprecated_member_use_from_same_package
          IOSWKNavigationResponse iosOnNavigationResponse = // ignore: deprecated_member_use_from_same_package
      ...
      case "onContextMenuActionItemClicked":
        ...
        if (contextMenu != null) {
          ...
          ContextMenuItem menuItemClicked = ContextMenuItem(id: id,
              // ignore: deprecated_member_use_from_same_package
              androidId: androidId,
              // ignore: deprecated_member_use_from_same_package
              iosId: iosId,
      ...
      case "onWindowBlur":
        ...
        break;
      case "onPrintRequest":
        if ((webviewParams != null && (webviewParams!.onPrintRequest !=
            null || // ignore: deprecated_member_use_from_same_package
          ...
          if (webviewParams != null) {
            if (webviewParams!.onPrintRequest != null)
              return await webviewParams!.onPrintRequest!(
                  _controllerFromPlatform, uri, printJob); else {
              // ignore: deprecated_member_use_from_same_package
      ...
      case "onCallJsHandler":
        ...
        Map<String, dynamic> handlerDataMap = call.arguments["data"].cast<
            String,
            dynamic>();
        // decode args to json
        ...
        switch (handlerName) {
          case "onLoadResource":
            if ((webviewParams != null &&
                ...
                _inAppBrowserEventHandler != null) {
              Map<String, dynamic> arguments = handlerData.args[0].cast<
                  String,
                  dynamic>();
              ...
              if (webviewParams != null &&
                ...
                return jsonEncode(
                    await params.webviewParams!.shouldInterceptAjaxRequest!(
                        _controllerFromPlatform, request)); else
                return jsonEncode(
            ...
            if ((webviewParams != null &&
              ...
              if (webviewParams != null &&
                ...
                return (await webviewParams!.onAjaxReadyStateChange!(
                    _controllerFromPlatform, request))?.toNativeValue(); else
                return (await _inAppBrowserEventHandler!.onAjaxReadyStateChange(
                    request))?.toNativeValue();
            }
            return null;
          case "onAjaxProgress":
            if ((webviewParams != null &&
          ...
          case "onWindowFocus":
            ...
            if (_inAppBrowserEventHandler != null) _inAppBrowserEventHandler!
                .onWindowFocus();
            return null;
          case "onWindowBlur":
            if (webviewParams != null && webviewParams!.onWindowBlur != null)
        ...
        if (_javaScriptHandlersMap.containsKey(handlerName)) {
          ...
          try {
            ...
            if (_javaScriptHandlersMap[handlerName]is JavaScriptHandlerCallback) {
              jsHandlerResult =
              await (_javaScriptHandlersMap[handlerName] as JavaScriptHandlerCallback)(
                  handlerData.args);
            } else
            if (_javaScriptHandlersMap[handlerName]is JavaScriptHandlerFunction) {
              jsHandlerResult =
              await (_javaScriptHandlersMap[handlerName] as JavaScriptHandlerFunction)(
                  handlerData);
            } else {
  ...
  @override
  Future<void> onFilePicked(List<String> files) async {
    await channel?.invokeMethod<void>('onFilePicked', {"files":jsonEncode(files)});
  }
...
"""))?.cast<Map<dynamic, dynamic>>() ?? [];
      for (var link in links) {
        if (link["rel"] == "manifest") {
          ...
          if (!_isUrlAbsolute(manifestUrl!)) {
            ...
            manifestUrl = ((assetPathBase == null) ? webviewUrl.scheme + "://" +
                webviewUrl.host + "/" : assetPathBase) + manifestUrl;
          }
          continue;
        }
        favicons.addAll(_createFavicons(
            webviewUrl, assetPathBase, link["href"], link["rel"], link["sizes"],
            false));
      }
    }
    ...
    try {
      HttpClient client = HttpClient();
      var faviconUrl = webviewUrl.scheme + "://" + webviewUrl.host +
          "/favicon.ico";
      ...
      try {
        ...
        if (manifest.containsKey("icons")) {
          for (Map<String, dynamic> icon in manifest["icons"]) {
            favicons.addAll(_createFavicons(
                webviewUrl, assetPathBase, icon["src"], icon["rel"],
                icon["sizes"], true));
          }
        }
      } catch (e) {
        developer.log(
            "Cannot get favicons from Manifest file. It might not have a valid format: " +
                e.toString(), error: e, name: runtimeType.toString());
      }
    }
  ...
  List<Favicon> _createFavicons(WebUri url, String? assetPathBase,
    ...
    if (!_isUrlAbsolute(urlIcon)) {
      ...
      urlIcon = ((assetPathBase == null)
          ? url.scheme + "://" + url.host + "/"
          : assetPathBase) + urlIcon;
    }
    if (isManifest) {
      rel = (sizes != null) ? urlSplit[urlSplit.length - 1].replaceFirst(
          "-" + sizes, "").split(" ")[0].split(".")[0] : null;
    }
  ...
  @override
  Future<void> loadUrl({required URLRequest urlRequest, @Deprecated(
      'Use allowingReadAccessTo instead') Uri? iosAllowingReadAccessTo, WebUri? allowingReadAccessTo}) async {
    assert(urlRequest.url != null && urlRequest.url
        .toString()
        .isNotEmpty);
  ...
  Future<void> loadData(
      {required String data, String mimeType = "text/html", String encoding = "utf8", WebUri? baseUrl, @Deprecated(
    ...
    args.putIfAbsent('historyUrl', () => historyUrl?.toString() ??
        androidHistoryUrl?.toString() ?? "about:blank");
    args.putIfAbsent(
        'allowingReadAccessTo', () => allowingReadAccessTo?.toString() ??
        iosAllowingReadAccessTo?.toString());
  ...
  void addJavaScriptHandler(
    ...
    assert(!kJavaScriptHandlerForbiddenNames.contains(
        handlerName), '"$handlerName" is a forbidden name!');
  ...
  Future<void> setOptions({required InAppWebViewGroupOptions options}) async {
    InAppWebViewSettings settings = InAppWebViewSettings.fromMap(
        options.toMap()) ?? InAppWebViewSettings();
  ...
  Future<WebHistory?> getCopyBackForwardList() async {
    ...
    Map<String, dynamic>? result = (await channel?.invokeMethod(
        'getCopyBackForwardList', args))?.cast<String, dynamic>();
  ...
  @override
  Future<void> zoomBy({required double zoomFactor, @Deprecated(
      'Use animated instead') bool? iosAnimated, bool animated = false}) async {
  ...
  Future<InAppWebViewHitTestResult?> getHitTestResult() async {
    ...
    InAppWebViewHitTestResultType? type = InAppWebViewHitTestResultType
        .fromNativeValue(hitTestResultMap["type"]?.toInt());
  ...
  Future<RequestImageRefResult?> requestImageRef() async {
    Map<String, dynamic> args = <String, dynamic>{};
    Map<dynamic, dynamic>? result = await channel?.invokeMethod(
        'requestImageRef', args);
    return result != null ? RequestImageRefResult(
      url: result['url'] != null ? WebUri(result['url']) : null,) : null;
  }
...
(function() {
  ...
  Future<Color?> getMetaThemeColor() async {
    ...
    themeColor =
    colorValue != null ? UtilColor.fromStringRepresentation(colorValue) : null;
  ...
  Future<SslCertificate?> getCertificate() async {
    ...
    Map<String, dynamic>? sslCertificateMap = (await channel?.invokeMethod(
        'getCertificate', args))?.cast<String, dynamic>();
  ...
  Future<CallAsyncJavaScriptResult?> callAsyncJavaScript(
      {required String functionBody, Map<String, dynamic> arguments = const <
          String,
          dynamic>{}, ContentWorld? contentWorld}) async {
    Map<String, dynamic> args = <String, dynamic>{};
  ...
  Future<AndroidWebMessageChannel?> createWebMessageChannel() async {
    Map<String, dynamic> args = <String, dynamic>{};
    Map<String, dynamic>? result = (await channel?.invokeMethod(
        'createWebMessageChannel', args))?.cast<String, dynamic>();
  ...
  Future<void> addWebMessageListener(
    ...
    assert(!_webMessageListeners.contains(
        webMessageListener), "${webMessageListener} was already added.");
    assert(!_webMessageListenerObjNames.contains(webMessageListener.params
        .jsObjectName), "jsObjectName ${webMessageListener.params
        .jsObjectName} was already added.");
  ...
  Future<bool> setSafeBrowsingAllowlist({required List<String> hosts}) async {
    ...
    return await _staticChannel.invokeMethod<bool>(
        'setSafeBrowsingAllowlist', args) ?? false;
  }
  ...
  Future<WebViewPackageInfo?> getCurrentWebViewPackage() async {
    ...
    Map<String, dynamic>? packageInfo = (await _staticChannel.invokeMethod(
        'getCurrentWebViewPackage', args))?.cast<String, dynamic>();
  ...
  Future<bool> isMultiProcessEnabled() async {
    Map<String, dynamic> args = <String, dynamic>{};
    return await _staticChannel.invokeMethod<bool>(
        'isMultiProcessEnabled', args) ?? false;
  }
  ...
  Future<void> setJavaScriptBridgeName(String bridgeName) async {
    assert(RegExp(r'^[a-zA-Z_]\w*$').hasMatch(
        bridgeName), 'bridgeName must be a non-empty string with only alphanumeric and underscore characters. It can\'t start with a number.');
    Map<String, dynamic> args = <String, dynamic>{};
