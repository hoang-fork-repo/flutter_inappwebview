...
public class InAppWebViewChromeClient extends WebChromeClient implements PluginRegistry.ActivityResultListener, ActivityResultListener {
    ...
    protected static final int FULLSCREEN_SYSTEM_UI_VISIBILITY_KITKAT =
            View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_FULLSCREEN | View.SYSTEM_UI_FLAG_IMMERSIVE | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY;
    protected static final int FULLSCREEN_SYSTEM_UI_VISIBILITY =
            View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_FULLSCREEN;
    ...
    public InAppWebViewChromeClient(@NonNull final InAppWebViewFlutterPlugin plugin,
                                    @NonNull InAppWebView inAppWebView,
    ...
    public void onHideCustomView() {
        ...
        if (inAppWebView != null) {
            ...
            if (eventWebViewChannelDelegate != null) eventWebViewChannelDelegate.onExitFullscreen();
            inAppWebView.setInFullscreen(false);
        }
    }

    @Override
    public void onShowCustomView(final View paramView,
                                 final CustomViewCallback paramCustomViewCallback) {
        if (this.mCustomView != null) {
            onHideCustomView();
            return;
        }
    ...
    public boolean onJsAlert(final WebView view, String url, final String message,
        ...
        if (inAppWebView != null && inAppWebView.channelDelegate != null) {
            inAppWebView.channelDelegate.onJsAlert(url, message, null,
                    new WebViewChannelDelegate.JsAlertCallback() {
                @Override
    ...
    public void createAlertDialog(String message, final JsResult result, String responseMessage,
        ...
        String alertMessage = (responseMessage != null && !responseMessage.isEmpty()) ?
    ...
    public boolean onJsConfirm(final WebView view, String url, final String message,
                               final JsResult result) {
        if (inAppWebView != null && inAppWebView.channelDelegate != null) {
            inAppWebView.channelDelegate.onJsConfirm(url, message, null,
                    new WebViewChannelDelegate.JsConfirmCallback() {
                @Override
                ...
                public void defaultBehaviour(@Nullable JsConfirmResponse response) {
                    ...
                    createConfirmDialog(message, result, responseMessage, confirmButtonTitle,
                            cancelButtonTitle);
                }
        ...
        if (inAppWebView != null && inAppWebView.channelDelegate != null) {
            inAppWebView.channelDelegate.onJsPrompt(url, message, defaultValue, null,
                ...
                public void defaultBehaviour(@Nullable JsPromptResponse response) {
                    ...
                    createPromptDialog(view, message, defaultValue, result, responseMessage,
                            responseDefaultValue, value, cancelButtonTitle, confirmButtonTitle);
                }
    ...
    public void createPromptDialog(WebView view, String message, String defaultValue,
                                   final JsPromptResult result, String responseMessage,
                                   String responseDefaultValue, String value,
                                   String cancelButtonTitle, String confirmButtonTitle) {
        FrameLayout layout = new FrameLayout(view.getContext());

        final EditText input = new EditText(view.getContext());
        input.setMaxLines(1);
        input.setText((responseDefaultValue != null && !responseDefaultValue.isEmpty()) ?
                responseDefaultValue : defaultValue);
    ...
    public boolean onJsBeforeUnload(final WebView view, String url, final String message,
                                    final JsResult result) {
        if (inAppWebView != null && inAppWebView.channelDelegate != null) {
            inAppWebView.channelDelegate.onJsBeforeUnload(url, message,
                    new WebViewChannelDelegate.JsBeforeUnloadCallback() {
                @Override
                ...
                public void defaultBehaviour(@Nullable JsBeforeUnloadResponse response) {
                    ...
                    createBeforeUnloadDialog(message, result, responseMessage, confirmButtonTitle
                            , cancelButtonTitle);
                }
    ...
    public void createBeforeUnloadDialog(String message, final JsResult result,
                                         String responseMessage, String confirmButtonTitle,
    ...
    public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture,
        ...
        CreateWindowAction createWindowAction = new CreateWindowAction(request, true,
                isUserGesture, false, windowId, isDialog);
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        if (inAppWebView != null && inAppWebView.channelDelegate != null) {
            inAppWebView.channelDelegate.onConsoleMessage(consoleMessage.message(),
...
//    boolean allowMultiple = fileChooserParams.getMode() == WebChromeClient.FileChooserParams
//    .MODE_OPEN_MULTIPLE;
...
//    return startPickerIntent(filePathCallback, acceptTypes, allowMultiple, captureEnabled);
        if (inAppWebView != null && inAppWebView.channelDelegate != null) {
            inAppWebView.channelDelegate.onFilePicker(acceptTypes,filePathCallback);
        }
        return true;
    }
    ...
    public void startPickerIntent(ValueCallback<Uri> filePathCallback, String acceptType,
        ...
        if (pickerIntent == null) {
            ...
            pickerIntent.putExtra(Intent.EXTRA_INITIAL_INTENTS,
    ...
    public boolean startPickerIntent(final ValueCallback<Uri[]> callback,
                                     final String[] acceptTypes, final boolean allowMultiple,
    ...
    protected boolean needsCameraPermission() {
        ...
        try {
            String[] requestedPermissions =
                    packageManager.getPackageInfo(activity.getApplicationContext().getPackageName(), PackageManager.GET_PERMISSIONS).requestedPermissions;
            if (Arrays.asList(requestedPermissions).contains(Manifest.permission.CAMERA) && ContextCompat.checkSelfPermission(activity, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                needed = true;
            }
    ...
    private Uri getOutputUri(String intentType) {
        ...
        String fileProviderAuthority =
                activity.getApplicationContext().getPackageName() + "." + InAppWebViewFileProvider.fileProviderAuthorityExtension;
        try {
            return FileProvider.getUriForFile(activity.getApplicationContext(),
                    fileProviderAuthority, capturedFile);
        } catch (Exception e) {
            Log.e(LOG_TAG, "", e);
        }
        return null;
    ...
    public void onPermissionRequest(final PermissionRequest request) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            final WebViewChannelDelegate.PermissionRequestCallback callback =
                    new WebViewChannelDelegate.PermissionRequestCallback() {
                @Override
    ...
    public void onPermissionRequestCanceled(PermissionRequest request) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && inAppWebView != null && inAppWebView.channelDelegate != null) {
            inAppWebView.channelDelegate.onPermissionRequestCanceled(request.getOrigin().toString(), Arrays.asList(request.getResources()));
        }
    }
